        ...
        <div className="space-y-3">
          {visibleItems.map((t) => (
            <div
              key={t.id}
              id={`todo-${t.id}`}
              className={`card hover:border-white/15 ${t.id === openRemindersForId ? "ring-1 ring-primary-500/30" : ""}`}
            >
              <div className="flex items-start justify-between gap-4">
                <div className="flex items-start gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="flex flex-wrap items-center gap-2 mt-3">
                      ...
                      {t.category ? (
                        <span className="text-xs px-2.5 py-1 rounded-full border border-primary-500/20 bg-primary-500/10 text-primary-200">
                          {t.category}
                        </span>
                      ) : null}
                    </div>
                ...
                <div className="flex items-center gap-1">
                  <button
                    ...
                    className="btn-ghost text-primary-200 flex items-center justify-center"
